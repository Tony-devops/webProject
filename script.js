...
http.onload = function(){
   if(this.readyState == 4 && this.status == 200){
      let products__movies = JSON.parse(this.responseText).slice(0,25);
      let output = "";
      for(let item of products__movies){
            ...
            <div class="product-movies">
               ...
               <p class="description"><span>Run time/Year/Dir.: </span><span>${item.description}</span></p>
               ...
               <p class="stock"><span>Stock Level: </span> <span>${item.stock}</span></p>
            </div>
         `;
      }
